...
espeak-data/phontab: espeak-data/phsource/ph_japanese espeak-data/phsource/phonemes.append espeak-data/voices/ja espeak-data/voices/mb/mb-jp
	...
	cp espeak-data/voices/mb/mb-jp ${HOME}/espeak-data/voices/mb/
...
#	cp espeak-data/phsource/mbrola/jp ${HOME}/espeak-data/phsource/mbrola/
#	espeakedit
#	if [ ! -d espeak-data/mbrola_ph/ ]; then mkdir -p espeak-data/mbrola_ph/; fi
#	cp ${HOME}/espeak-data/mbrola/jp_phtrans espeak-data/mbrola/
